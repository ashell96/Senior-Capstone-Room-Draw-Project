  ...
  <div id="app">
    <nav class="site-header sticky-top py-1">
      <div class="container d-flex flex-column flex-md-row justify-content-between">
        ...
        <router-link class="py-2 d-none d-md-inline-block" to="/Traditional">Traditional</router-link>
        <router-link class="py-2 d-none d-md-inline-block" to="/">Go to Hello</router-link>
        <router-link class="py-2 d-none d-md-inline-block" to="Squatting">Squatting</router-link>
